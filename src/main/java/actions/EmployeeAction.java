...
public class EmployeeAction extends ActionBase{
    ...
    public void create() throws ServletException, IOException{
        ...
        if(checkAdmin()&&checkToken()) {
            ...
            if(errors.size() > 0) {
                ...
                putRequestScope(AttributeConst.EMPLOYEE, ev);  //入力された従業員
                ...
                putSessionScope(AttributeConst.FLUSH, MessageConst.I_RESISTERD.getMessage());
    ...
    public void edit() throws ServletException, IOException{
      ...
      //idを条件に従業員データを取得
        ...
        putRequestScope(AttributeConst.TOKEN, getTokenId()); //CSRF対策
        putRequestScope(AttributeConst.EMPLOYEE, ev);  //取得した従業員
