...
public class EmployeeValidator {
     ...
     * @param codeDuplicateCheckFlag 社員番号の重複チェックを実施するか(実施する:true,実施しない:false)
     * @param passwordCheckFlag パスワードの入力チェックを実施するか(実施する:true,実施しない:false)
     * @return エラーのリスト
     */
    ...
    /**
     * 氏名に入力値があるかどうかをチェックし、入力値がなければエラーメッセージを返却
     * @param name 氏名
     * @return エラーメッセージ
     */
    ...
    private static String validatePassword(String password, Boolean passwordCheckFlag) {
        ...
        //入力チェックを実施かつ入力値が無ければエラーメッセージを返却
